...
> **Business Question:** How severe is the overall churn problem, and what proportion of our customer base is at risk?

* 20.37% of all customers churned (approximately 1 in 5 customers).

2. Churn by Geography 
> **Business Question:** Which countries have the highest churn, and how should regional retention strategies differ?
...
> **Business Question:** Does customer tenure affect likelihood of churn, and which tenure group should we prioritize for retention?
...
> **Business Question:** Does credit risk predict churn, and should interventions focus on certain risk groups?
* High risk: 22.17%
* Medium risk: 19.78%
* Low risk: 19.92%
...
> **Business Question:** Are high-balance active customers at higher risk of leaving, and what service improvements could retain them?
...
> **Business Question:** Which gender and age groups are most at risk, and how can marketing and retention efforts be tailored?
...
**Business Question:** How does customer activity level relate to churn, and which engagement strategies could reduce it?
...
**Business Question:** Does a large balance relative to salary indicate risk of churn, and how can we better serve these customers?
...
**Business Question:** Does product engagement influence churn, and how should product strategy adapt?
...
> **Business Question:** Which regions cause the highest financial impact when customers churn?
...
> **Business Question:** Which age segments are most financially impactful if they churn?
...
> **Business Question:** Does gender affect revenue loss from churn?
...
> **Business Question:** How does credit risk segment influence financial losses due to churn?
...
> **Business Question:** How does tenure influence financial impact, and which tenure groups require retention focus?
